...
//        }
    ...
    public BizResult<DoctorVisitSet> setVisit(@Valid @RequestBody DoctorVisitSetDto request) {
    ...
    public BizResult<DoctorWelcomeMessageSet> setWelcomeMessage(@Valid @RequestBody DoctorWelcomeMessageDto request) {
